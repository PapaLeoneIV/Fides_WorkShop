...
import { validateAndHandleBikeResponse, validateAndHandleHotelResponse, validateAndHandlePaymentResponse } from "./controller/response-controller";
...
async function main() {
   ...
   //CONSUME SAGA
   subscriber.consume(queue.SAGA_HOTEL_RESP, EXCHANGE, PUBLISH_HOTEL_SAGA_BK, (msg) => validateAndHandleHotelResponse(msg));
